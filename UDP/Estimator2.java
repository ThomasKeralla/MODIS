...
public class Estimator2 {
    ...
    private class Send implements Runnable {
        public void run() {
            for(String msg : messages){
                ReliableUDPClient sender = new ReliableUDPClient(host.getHostAddress(), 7007, msg);
               /* try {
    ...
    public static void main(String[] args) {
        ...
        String host = "192.168.48.161";//"62.61.130.232";//"80.62.117.57";//"localhost";        
